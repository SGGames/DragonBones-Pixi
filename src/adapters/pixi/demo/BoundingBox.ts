import { OffsetMode } from "../../../dragonBones";
import { Bone } from "../../../dragonBones/armature/Bone";
...
export default class BoundingBox extends BaseDemo {
    ...
    private _boundingBoxTester: PixiArmatureDisplay;
    private _targetA: PixiArmatureDisplay;
    private _targetB: PixiArmatureDisplay;
    private _line: Bone;
    private _pointA: Bone;
    ...
    protected _onStart(): void {
        ...
        factory.parseTextureAtlasData(this._pixiResources["resource/mecha_2903/mecha_2903_tex.json"], 
            this._pixiResources["resource/mecha_2903/mecha_2903_tex.png"]);
        factory.parseDragonBonesData(this._pixiResources["resource/bounding_box_tester/bounding_box_tester_ske.json"]);
        factory.parseTextureAtlasData(this._pixiResources["resource/bounding_box_tester/bounding_box_tester_tex.json"], 
            this._pixiResources["resource/bounding_box_tester/bounding_box_tester_tex.png"]);
        //
        ...
        DragHelper.getInstance().stage = this.container;
    ...
    private _enterFrameHandler(ticker: any): void { // Make sure game update before dragonBones update.
