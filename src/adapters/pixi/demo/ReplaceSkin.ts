...
export default class ReplaceSkin extends BaseDemo {
    ...
    protected _onStart(): void {
        this._factory.parseDragonBonesData(this._pixiResources["resource/you_xin/body/body_ske.json"]);
        this._factory.parseTextureAtlasData(this._pixiResources["resource/you_xin/body/body_tex.json"], 
        this._pixiResources["resource/you_xin/body/body_tex.png"]);
        ...
        for (let i = 0, l = this._suitConfigs.length; i < l; ++i) {
            for (const partArmatureName of this._suitConfigs[i]) {
                ...
                const textureAtlasPath = path + "_tex.png";
                //
                this._factory.parseDragonBonesData(this._pixiResources[dragonBonesJSONPath]);
                this._factory.parseTextureAtlasData(this._pixiResources[textureAtlasJSONPath], 
                    this._pixiResources[textureAtlasPath]);
            }
        }
        //
