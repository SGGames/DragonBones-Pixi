...
import { Transform } from "../../../dragonBones/geom/Transform";
...
export default class InverseKinematics extends BaseDemo {
    ...
    protected _onStart(): void {
        ...
        const touchHandler = (event: any) => {
            this._target.x = event.data.global.x - this.container.x;
            this._target.y = event.data.global.y - this.container.y;
        };
        ...
        factory.parseTextureAtlasData(this._pixiResources["resource/mecha_1406/mecha_1406_tex.json"], 
        this._pixiResources["resource/mecha_1406/mecha_1406_tex.png"]);
        factory.parseDragonBonesData(this._pixiResources["resource/floor_board/floor_board_ske.json"]);
        factory.parseTextureAtlasData(this._pixiResources["resource/floor_board/floor_board_tex.json"], 
        this._pixiResources["resource/floor_board/floor_board_tex.png"]);
        //
    ...
    private _enterFrameHandler(): void { // Make sure game update before dragonBones update.
        //deltaTime: number
        this._updateAim();
        this._updateFoot();
    }
