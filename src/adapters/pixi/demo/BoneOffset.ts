...
export default class BoneOffset extends BaseDemo {
    ...
    protected _onStart(): void {
        ...
        factory.parseDragonBonesData(this._pixiResources["resource/bullet_01/bullet_01_ske.json"]);
        factory.parseTextureAtlasData(this._pixiResources["resource/bullet_01/bullet_01_tex.json"], 
        this._pixiResources["resource/bullet_01/bullet_01_tex.png"]);
